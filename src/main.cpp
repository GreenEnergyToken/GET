...
unsigned int nTargetSpacing = 1 * 30; // GET - 0.5 minute blocks
...
unsigned int nModifierInterval = 10 * 60; // GET - time to elapse before new modifier is computed
...
const string strMessageMagic = "GET Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "GET", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "http://www.dailyrecord.co.uk/in-your-area/green-energy-bright-business-idea-11164395";
        CTransaction txNew;
        txNew.nTime = 1505398542;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1505398542;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 35852070;
        ...
        assert(block.hashMerkleRoot == uint256("0x2a4809237a7fb06b4769c634e6bebdcf39fbc204a9b07b0a0790e59e6e77f59b"));
