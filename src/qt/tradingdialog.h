...
private slots:
    ...
    void on_BuyGET_clicked();
    void on_SellGETBTN_clicked();
    void on_SellBidcomboBox_currentIndexChanged(const QString &arg1);
    void on_Sell_Max_Amount_clicked();
    void on_UnitsInputGET_textChanged(const QString &arg1);
    ...
    QString BuyGET(QString OrderType, double Quantity, double Rate);
    QString SellGET(QString OrderType, double Quantity, double Rate);
