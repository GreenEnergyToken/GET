...
!define URL http://www.GET.ru/

# MUI Symbol Definitions
!define MUI_ICON "../share/pixmaps/GET.ico"
...
#!define MUI_FINISHPAGE_RUN $INSTDIR\GET-qt.exe
...
OutFile GET-0.3.0-win32-setup.exe
...
Section -Main SEC0000
    ...
    #Delete /REBOOTOK $INSTDIR\GET.exe
...
Section /o -un.Main UNSEC0000
    #Delete /REBOOTOK $INSTDIR\GET-qt.exe
